...
//
//// Show create form
//// Route here must be ahead of `single listing` part
...
//    [\App\Http\Controllers\ListingController::class, 'edit'])->middleware('auth');
//
//// Edit Submit to Update
//Route::put('/listings/{listing}',
//    [\App\Http\Controllers\ListingController::class, 'update'])->middleware('auth');
//
//// Edit Submit to Update
//Route::delete('/listings/{listing}',
//    [\App\Http\Controllers\ListingController::class, 'destroy'])->middleware('auth');
//
//// Manage Listings
